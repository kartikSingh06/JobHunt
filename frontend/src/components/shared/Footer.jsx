      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="mb-6 md:mb-0">
            <h2 className="text-3xl font-bold mb-2">Job Hunt</h2>
          ...
          <div className="text-center md:text-left">
            ...
            <form action="#" method="POST" className="flex flex-col md:flex-row items-center">
              <input
                ...
                className="mb-4 md:mb-0 md:mr-4 p-2 rounded bg-gray-700 text-white placeholder-gray-400 border border-gray-600"
                required
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div>
            ...
            <p className="text-sm">1234 Job Street, Suite 100<br />City, State, 12345</p>
            <p className="text-sm">Email: <a href="mailto:info@yourcompany.com" className="hover:text-gray-400">query.jobHunt@gmail.com</a></p>
          </div>
        </div>
      </div>
    </footer>
